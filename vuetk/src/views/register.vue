	...
	<el-row type="flex" align="middle" justify="center">
		<el-col span="8">
			<h1 class="title"><img src="../images/logo.png" width="200" height="60"></h1>
					...
					<el-input :value.sync="user.name" placeholder="请输入呢称">
					...
					<el-input type="password" :value.sync="user.password" placeholder="请输入密码">
						<Icon type="ios-locked-outline" slot="prepend"></Icon>
					</el-input>


					<el-input type="password" :value.sync="user.password_confirmation" placeholder="请再输入一次密码">
						<Icon type="ios-locked-outline" slot="prepend"></Icon>
					</el-input>

		            <el-button type="ghost" :loading="button.loading" @click="loginSubmit('formValidate')" long>{{ button.text }}</el-button>
